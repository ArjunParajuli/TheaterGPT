...
const MovieDetails = () => {
    ...
    const eachMovieDetails = useSelector((state) => state.movies?.eachMovieDetails);
        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="max-w-4xl w-full mx-4 bg-white rounded-lg overflow-hidden shadow-xl">
                ...
                <div className="p-6">
                    ...
                    <button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50" onClick={() => navigate(-1)}>Go Back</button>
                </div>
            </div>
        </div>
    );
